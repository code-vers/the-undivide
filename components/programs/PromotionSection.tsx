      ...
      <div className="relative z-10 mx-auto max-w-[1760px] px-4 md:px-[80px] w-full">
        <div className="flex flex-col items-center gap-[16px]">
          ...
          <div className="flex flex-wrap gap-[16px] justify-center mt-10">
            ...
            <Button variant="outline" className="border-2 border-[#f8f8f2] text-[#f8f8f2] hover:bg-[#f8f8f2] hover:text-[#1c3530] h-[51px] px-[27px] rounded-[8px] text-[16px] font-semibold">
              Contact With Us
            </Button>
          </div>
        </div>
